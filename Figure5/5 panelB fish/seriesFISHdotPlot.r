...
#load input files
VE821ser_DMSO_FISH <- read.csv("231inhibitorVE821-dmso.csv", sep=",")
VE821ser_DMSO_FISH$dose <- as.factor(VE821ser_DMSO_FISH$dose)

#make dot plot of FISH data series   
ggplot(VE821ser_DMSO_FISH, aes(dose, green_red, fill = count, color = count)) + 
...
#save the files
ggsave("5B.tiff", device="tiff", width =3.53, height =2.61 , units ="in" , dpi=300)
