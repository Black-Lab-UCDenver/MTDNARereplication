...
#load input files
VE821redo_UNC_VE821_FISH <- read.csv("231inhibitorVE821-1stsetredo-ve821+unc.csv", sep=",")
VE821redo_UNC_VE821_FISH$dose <- as.factor(VE821redo_UNC_FISH$dose)

#make dot plot of FISH data series   
ggplot(VE821redo_UNC_VE821_FISH, aes(dose, green_red, fill = count, color = count)) + 
...
#save the files
ggsave("S5E.tiff", device="tiff", width =3.53, height =2.61 , units ="in" , dpi=300)
