...
customRefSeqTxDb12 <- GeneRegionTrack(txdbRefseq, 
					chromosome="chr12", 
					name="RefSeq", 
					fontcolor="black")

displayPars(customRefSeqTxDb12) <- list(fontcolor.group = "blue", 
					fontcolor.item="blue",
					col="blue", 
					fill = "blue", 
					col.line = "blue", 
...
parentalChIPTrackOut <- DataTrack(parentalChIP, 
				genome="hg38", 
				type="hist" ,
				chromosome ="chr16", 
				name = " ", 
...
cadR10ChIPTrackOut <- DataTrack(cadR10ChIP, 
				genome="hg38", 
				type="hist" ,
				chromosome ="chr16", 
				name = " ", 
...
parentalEZH2zoom8Track <- DataTrack(parentalEZH2, 
...
cadR10EZH2zoom8Track <- DataTrack(cadR10EZH2, 
				genome="hg38", 
				type="hist" ,
				chromosome ="chr16", 
				name = " ", 
...
parentalSUZ12zoom8Track <- DataTrack(parentalSUZ12, 
				genome="hg38", 
				type="hist" ,
				chromosome ="chr16", 
				name = " ", 
...
cadR10SUZ12zoom8Track <- DataTrack(cadR10SUZ12, 
				genome="hg38", 
				type="hist" ,
				chromosome ="chr16", 
				name = " ", 
...
tiff(filename="S3L.tiff",width = 280, height = 572, units = "px", compression = "none", res = 118.11)
plotTracks(c(parentalChIPTrackOut, cadR10ChIPTrackOut, OkasakiTrack, parentalEZH2zoom8Track, cadR10EZH2zoom8Track, parentalSUZ12zoom8Track, cadR10SUZ12zoom8Track, parental10rerepTrack, cadR10rerepTrack, parental75rerep50binTrack, cadR75rerep50binTrack, gtrack, customRefSeqTxDb12), from=4239000, to=4354000,chromosome="chr12", type="histogram", labelPos="below", background.title="white", ticksAt=c(4269000, 4324000))
dev.off()
