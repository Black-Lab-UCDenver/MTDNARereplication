...
tiff(filename="3H.tiff",width = 280, height = 572, units = "px", compression = "none", res = 118.11)
plotTracks(c(parentalChIPTrack, cadR10ChIPTrack, OkasakiTrack, parentalEZH2zoom5Track, cadR10EZH2zoom5Track, parentalSUZ12zoom5Track, cadR10SUZ12zoom5Track, parental10rerepTrack, cadR10rerepTrack, parental75rerep50binTrack, cadR75rerep50binTrack, gtrack, customRefSeqTxDb2), from=56657000, to=56665000 ,chromosome="chr16", type="histogram", labelPos="below", background.title="white", ticksAt=c(56659000,56663000))
dev.off()
