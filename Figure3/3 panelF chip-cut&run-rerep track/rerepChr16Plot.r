...
parentalChIPzoomTrack <- DataTrack(parentalChIP, 
				genome="hg38", 
				type="hist" ,
				chromosome ="chr16", 
				name = " ", 
...
cadR10ChIPzoomTrack <- DataTrack(cadR10ChIP, 
				genome="hg38", 
				type="hist" ,
				chromosome ="chr16", 
				name = " ", 
...
parentalEZH2zoom1Track <- DataTrack(parentalEZH2, 
...
cadR10EZH2zoom1Track <- DataTrack(cadR10EZH2, 
				genome="hg38", 
				type="hist" ,
				chromosome ="chr16", 
				name = " ", 
...
parentalSUZ12zoom1Track <- DataTrack(parentalSUZ12, 
				genome="hg38", 
				type="hist" ,
				chromosome ="chr16", 
				name = " ", 
...
cadR10SUZ12zoom1Track <- DataTrack(cadR10SUZ12, 
				genome="hg38", 
				type="hist" ,
				chromosome ="chr16", 
				name = " ", 
...
tiff(filename="3F.tiff",width = 280, height = 572, units = "px", compression = "none", res = 118.11)
plotTracks(c(parentalChIPzoomTrack, cadR10ChIPzoomTrack, OkasakiTrack, parentalEZH2zoom1Track, cadR10EZH2zoom1Track, parentalSUZ12zoom1Track, cadR10SUZ12zoom1Track, parental10rerepTrack, cadR10rerepTrack, parental75rerep50binTrack, cadR75rerep50binTrack, gtrack, customRefSeqTxDb2), from=56613430, to=56621923,chromosome="chr16", type="histogram", labelPos="below", background.title="white", ticksAt=c(56615000, 56620000))
dev.off()
