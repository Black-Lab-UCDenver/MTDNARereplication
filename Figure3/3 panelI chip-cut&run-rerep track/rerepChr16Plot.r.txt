...
parentalEZH2zoom5Track <- DataTrack(parentalEZH2, 
...
cadR10EZH2zoom5Track <- DataTrack(cadR10EZH2, 
				genome="hg38", 
				type="hist" ,
				chromosome ="chr16", 
				name = " ", 
...
parentalSUZ12zoom5Track <- DataTrack(parentalSUZ12, 
				genome="hg38", 
				type="hist" ,
				chromosome ="chr16", 
				name = " ", 
...
cadR10SUZ12zoom5Track <- DataTrack(cadR10SUZ12, 
				genome="hg38", 
				type="hist" ,
				chromosome ="chr16", 
				name = " ", 
...
tiff(filename="3I.tiff",width = 280, height = 572, units = "px", compression = "none", res = 118.11)
plotTracks(c(parentalChIPzoomTrack, cadR10ChIPzoomTrack, OkasakiTrack, parentalEZH2zoom5Track, cadR10EZH2zoom5Track, parentalSUZ12zoom5Track, cadR10SUZ12zoom5Track, parental10rerepTrack, cadR10rerepTrack, parental75rerep50binTrack, cadR75rerep50binTrack, gtrack, customRefSeqTxDb2), from=56680665, to=56691744, chromosome="chr16", type="histogram", labelPos="below", background.title="white", ticksAt=c(56683000,56690000))
dev.off()
