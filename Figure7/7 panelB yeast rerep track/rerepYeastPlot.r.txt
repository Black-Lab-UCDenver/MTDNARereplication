...
yeastWtbothTrack <- DataTrack(yeastWtboth, 
			genome="SacCer3", 
			type="hist" ,
			chromosome ="chrVIII", 
			name = " ", 	
...
yeastCubothTrack <- DataTrack(yeastCuboth, 
			genome="SacCer3", 
			type="hist" ,
			chromosome ="chrVIII", 
			name = " ", 
...
plotTracks(c(yeastWtbothTrack, yeastCubothTrack, gtrack, yeastGenes), from=210000, to=218000, chromosome = "chrVIII", type="histogram", labelPos="below", background.title="white")
dev.off()
