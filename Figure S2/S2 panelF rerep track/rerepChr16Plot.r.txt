...
parental10rerepSmooth <- rtracklayer::import.bedGraph("Parental18MergedAveraged.50bp.10kbsmooth.bedgraph")
cadR10rerepSmooth <- rtracklayer::import.bedGraph("Cad18MergedAveraged.50bp.10kbsmooth.bedgraph")
...
parental10rerepSmoothTrack <- DataTrack(parental10rerepSmooth, 
					genome="hg38", 
					type="hist" ,
					chromosome ="chr16", 
					name = " ", 
...
cadR10rerepSmoothTrack <- DataTrack(cadR10rerepSmooth, 
					genome="hg38", 
					type="hist" ,
					chromosome ="chr16", 
					name = " ", 
...
tiff(filename="2G.tiff",width = 680, height = 330, units = "px", compression = "none", res = 118.11)
